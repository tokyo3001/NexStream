  ...
  return (
    ...
    md:justify-center md:bg-transparent"> 
      ...
      <Image
        ...
        objectFit="cover"
      />
      <div className="absolute left-4 top-4 cursor-pointer object-contain text-yellow-600 font-serif text-4xl font-bold md:left-10 md:top-6">NexStream</div>

      <form 
      onSubmit={handleSubmit(onSubmit)}
      className="relative mt-24 space-y-8 rounded bg-black py-10 px-6 md:mt-0
